...
Best retrieval-only configuration after MMR testing: **MMR_LAMBDA_06**. Best evaluated generation system: **Final selected generation bake-off strategy**.
...
MMR generation selection decision: `selected_mmr_end_to_end`. Final bake-off decision: `kept_previous_best_generation_strategy`.
