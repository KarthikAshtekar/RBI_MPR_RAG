...
Retrieval-only winner after MMR testing: `MMR_LAMBDA_06`. Best evaluated generation setting: `V2 Cohere retrieval + sufficiency-gated generation`.
...
| MMR06 + sufficiency gate | not available | not available | not available | not available | not available | not available |
