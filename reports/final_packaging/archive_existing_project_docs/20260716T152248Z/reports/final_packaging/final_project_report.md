...
Best retrieval-only configuration after MMR testing: **MMR_LAMBDA_06**. Best evaluated generation system: **V2 Cohere retrieval + sufficiency-gated generation**.
...
|---|---:|---:|---:|---:|---:|---:|
| V2 Cohere retrieval | 0.4667 | 0.5000 | 0.6000 | 0.4154 | 12948.27 | 2097.20 |
| MMR lambda 0.6 retrieval | 0.5333 | 0.5667 | 0.6500 | 0.4055 | 15217.14 | 2037.03 |

## Final generation metrics

MMR generation selection decision: `not_run`. Final bake-off decision: `not_run`.

| Metric | Previous V2 sufficiency | MMR06 sufficiency | Selected value |
|---|---:|---:|---:|
| Factual correctness | 0.7954 | not available | 0.7954 |
| Faithfulness to context | 0.9762 | not available | 0.9762 |
| Abstention correctness | 1.0000 | not available | 1.0000 |
| Citation correctness | 0.8824 | not available | 0.8824 |
| Citation completeness | 1.0000 | not available | 1.0000 |
| Temporal attribution correctness | 0.8824 | not available | 0.8824 |
| Comparative correctness | 0.2778 | not available | 0.2778 |
