...
Best generation system: **V2 Cohere Retrieval + Sufficiency-Gated Generation**. Best retrieval-only configuration after MMR testing: **MMR_LAMBDA_06**. Generation was not rerun on MMR, so generation metrics remain tied to `V2_COHERE_ONLY` retrieval.
