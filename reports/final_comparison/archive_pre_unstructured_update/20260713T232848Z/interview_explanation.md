...
5. **What is MMR and did it help?**  
   MMR is Maximal Marginal Relevance, a diversity selection method. This project did not run a true standalone MMR experiment; it ran an exact-overlap diversity filter, which is different.
...
11. **What are the limitations?**  
   Current V2 results are development-only, metrics are deterministic heuristics, Unstructured extraction is blocked by missing Poppler, and Cohere adds latency.
