...
from rbi_rag.v2_sufficiency import run_v2_sufficiency_generation


def main() -> int:
    parser = argparse.ArgumentParser(description="Run V2 sufficiency-gated development generation.")
    ...
    result = run_v2_sufficiency_generation(
        ROOT,
        split=args.split,
